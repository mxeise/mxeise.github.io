...
window.onload = function () {
  ...
  (0, _jquery2.default)(function () {
    (0, _jquery2.default)('form').submit(function () {
      var search = (0, _jquery2.default)('#search_input').val();
      _jquery2.default.getJSON(cors + api + search, function (results) {
        (0, _jquery2.default)('#results').empty();
        console.log(results);
        _jquery2.default.each(results.query.pages, function (i, value) {
          (0, _jquery2.default)('#results').append('<div id="result_spacing" class="row align-center"><div class="large-8 columns"><div class="callout"><h4>' + value.title + '</h4>' + '<p>' + value.extract + '</p>' + '</div></div>');
        });
      });
      return false;
    });
